...
from fiji.plugin.trackmate.detection import LogDetectorFactory, LabelImageDetectorFactory
...
for i in range(0, len(fnames)):
	...
	print "Initial dimensions: (x,y,c,z,t) = %d %d %d %d %d" % (
        imp.getWidth(), imp.getHeight(),
        imp.getNChannels(), imp.getNSlices(), imp.getNFrames())
	if dims[4] == 1:
		print "Swapping z and t"
		imp = swap_zt(imp)
